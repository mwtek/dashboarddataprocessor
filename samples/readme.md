...
* <a href="./SampleBundle_Covid.json" target="_blank">SampleBundle_Covid.json</a>
    * Bundle of 7 patients.
        * 6 patients with inpatient icu covid-19 cases
...
* <a href="./SampleBundle_Influenza.json" target="_blank">SampleBundle_Influenza.json</a>
    * Bundle of 6 patients.
        ...
        * 1 patient with three positive influenza encounters in different years.
* <a href="./SampleBundle_KiRadar.json" target="_blank">SampleBundle_KiRadar.json</a>
    * Bundle of 10 patients.
        ...
        * A patient with 2 different diagnoses (F71.1, F63.1) in two diagnosis groups ('
          intellectual-developmental-disorders', 'other-psychological-disorders')
        * A patient with 2 different diagnoses (F90.9, F63.1) in two diagnosis groups ('
          attention-deficit-hyperactivity-disorder', 'other-psychological-disorders')
        ...
        * A patient with an active case and a rsv diagnosis (J21.0) who also got an active high-flow
          procedure.
        * A patient with 2 cases (one active; one completed), a rsv diagnosis (J21.0), a covid
          diagnosis (U07.1), a pertussis diagnosis (A37.8), who also got an active cpap procedure.
        * A patient with an active case, a finished ventilation procedure and a pertussis pcr.
        * A kjp patient with a finished case in 2024 with 3 intensive care procedures.
* <a href="./SampleBundle_Acribis.json" target="_blank">SampleBundle_Acribis.json</a>
    * Bundle of 8 patients with 11 consent formulars in total.
        * 2 Patients with 2 consents forms each (valid main + valid acribis form with data usage
          permission).
            * One with 2 different follow-up forms
        * One patient with a declined main consent form who also got a positive follow-up, which
          should not be used in the further logic.
        ...
        * One patient who got main and acribis consent in one single resource, belongs to
          ...
          is older than the consent approval and should get ignored.
            * Got also a positive follow-up questionnaire response.
...
* <a href="./SampleBundle_Bct.json" target="_blank">SampleBundle_Bct.json</a>
    * Bundle of 5 patients with 8 consent formulars in total.
        * 1 Patients with 2 consents forms each where both a valid
        * 1 Patient with a valid consent but some of the modules are denied
        * 1 Patient with a revoked consent
        * 1 Patient with a revoked consent, followed by a valid consent
        * 1 Patient with 2 valid consents
